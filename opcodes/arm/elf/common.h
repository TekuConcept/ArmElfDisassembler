...
#define SHF_EXCLUDE	0x80000000	/* Link editor is to exclude this section from executable and shared library that it builds when those objects are not to be further relocated.  */
...
#define AT_SUN_CAP_HW1	2009	/* Machine dependent hints about processor capabilities.  */
...
#define	AT_SUN_EMULATOR	2018	/* Name of emulation binary for runtime linker.  */
